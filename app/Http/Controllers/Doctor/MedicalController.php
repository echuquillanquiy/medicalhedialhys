...
class MedicalController extends Controller
{
    ...
    public function performValidation (Request $request) {
        ...
        $messages = [
            ...
            'clinical_trouble.min' => 'Los problemas clínicos deben tener mínimo 5 carácteres.',
            'evaluation.min' => 'La evaluación debe tener mínimo 10 carácteres.',
            'indications.min' => 'Las indicaciones debe tener mínimo 10 carácteres.',
